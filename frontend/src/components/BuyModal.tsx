...
export default function BuyModal({ property, onClose, onSuccess }: BuyModalProps) {
    ...
    const rawPrice = tokenAmount * property.price_per_token; // Saf Mülk Bedeli
    const fee = rawPrice * 0.015; // %1.5 İşlem Ücreti (Backend ile aynı olmalı)
    const totalCost = rawPrice + fee; // Toplam Tutar
