    ...
    if (!images || images.length === 0) {
        return (
            <div className="w-full aspect-[4/3] md:aspect-[16/9] bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-center justify-center text-slate-400">
                ...
                <span className="text-sm font-medium">{t.common.images.noImages}</span>
            </div>
        );
    }
                ...
                {sortedImages.length > 1 && (
                    <>
                        <button
                            ...
                            aria-label={t.common.images.previousImage}
                        >
                            <ChevronLeft size={20} />
                        </button>
                        <button
                            ...
                            aria-label={t.common.images.nextImage}
                        >
                    ...
                    <div className="flex gap-3 overflow-x-auto scrollbar-hide py-1 px-1 snap-x">
                        {sortedImages.map((image, index) => (
                            ...
                            >
                                <img
                                    src={image.url}
                                    alt={t.common.images.thumbnailAlt.replace('{index}', String(index + 1))}
